...
def create_store_collection():
    ...
    schema.add_field(field_name="timestamp", datatype=DataType.INT64, max_length=1000, nullable=True)
    schema.add_field(field_name="message_type", datatype=DataType.VARCHAR, max_length=1000, nullable=True)
    ...
    client.create_collection(
        collection_name=CONTEXT_COLLECTION_NAME, schema=schema, index_params=index_params
    )
